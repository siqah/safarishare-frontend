      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-4">
            <Link
              to="/register"
              className="text-sm font-medium text-white bg-blue-600 hover:bg-blue-500 px-4 py-2 rounded-md"
            >
              Register
            </Link>
            <Link
          ...
          <div className="md:hidden border-t border-gray-200 py-4">
            <div className="space-y-2">
              <Link
                ...
                className="block px-3 py-2 text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-500"
              >
                Register
              </Link>
              <Link
